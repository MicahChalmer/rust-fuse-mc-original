...
pub fn make_fuse_ll_oper(ops:&FuseLowLevelOps)
    ...
    return Struct_fuse_lowlevel_ops {
        init: if ops.init_is_implemented() { init_impl } else { 0 as extern "C" fn(userdata:*mut c_void, _conn:*Struct_fuse_conn_info) },
        destroy: if ops.destroy_is_implemented() { destroy_impl } else { 0 as extern "C" fn(userdata:*mut c_void) },
        lookup: if ops.lookup_is_implemented() { lookup_impl } else { 0 as extern "C" fn(req:fuse_req_t,  parent:fuse_ino_t, name:*c_schar) },
        forget: if ops.forget_is_implemented() { forget_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, nlookup:c_ulong) },
        getattr: if ops.getattr_is_implemented() { getattr_impl } else { 0 as extern "C" fn(req:fuse_req_t, ino: fuse_ino_t, _fi:*Struct_fuse_file_info) },
        setattr: if ops.setattr_is_implemented() { setattr_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, attr:*stat, to_set: int, fi: *Struct_fuse_file_info) },
        readlink: if ops.readlink_is_implemented() { readlink_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t) },
        mknod: if ops.mknod_is_implemented() { mknod_impl } else { 0 as extern "C" fn(req:fuse_req_t, parent: fuse_ino_t, name:*c_schar, mode: mode_t, rdev: dev_t) },
        mkdir: if ops.mkdir_is_implemented() { mkdir_impl } else { 0 as extern "C" fn(req: fuse_req_t, parent: fuse_ino_t, name:*c_schar,  mode:mode_t) },
        unlink: if ops.unlink_is_implemented() { unlink_impl } else { 0 as extern "C" fn(req: fuse_req_t, parent: fuse_ino_t, name:*c_schar) },
        rmdir: if ops.rmdir_is_implemented() { rmdir_impl } else { 0 as extern "C" fn(req: fuse_req_t, parent: fuse_ino_t, name:*c_schar) },
        symlink: if ops.symlink_is_implemented() { symlink_impl } else { 0 as extern "C" fn(req: fuse_req_t, link: *c_schar, parent: fuse_ino_t, name: *c_schar) },
        rename: if ops.rename_is_implemented() { rename_impl } else { 0 as extern "C" fn(req: fuse_req_t, parent: fuse_ino_t, name: *c_schar, newparent: fuse_ino_t, newname: *c_schar) },
        link: if ops.link_is_implemented() { link_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, newparent: fuse_ino_t, newname: *c_schar) },
        open: if ops.open_is_implemented() { open_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, fi: *Struct_fuse_file_info) },
        read: if ops.read_is_implemented() { read_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, size: size_t, off: off_t, fi: *Struct_fuse_file_info) },
        write: if ops.write_is_implemented() { write_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, buf: *u8, size: size_t, off: off_t, fi: *Struct_fuse_file_info) },
        flush: if ops.flush_is_implemented() { flush_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, fi: *Struct_fuse_file_info) },
        release: if ops.release_is_implemented() { release_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, fi: *Struct_fuse_file_info) },
        fsync: if ops.fsync_is_implemented() { fsync_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, datasync: c_int, fi: *Struct_fuse_file_info) },
        opendir: if ops.opendir_is_implemented() { opendir_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, _fi: *Struct_fuse_file_info) },
        readdir: if ops.readdir_is_implemented() { readdir_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, size: size_t, off: off_t, fi: *Struct_fuse_file_info) },
        releasedir: if ops.releasedir_is_implemented() { releasedir_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, fi: *Struct_fuse_file_info) },
        fsyncdir: if ops.fsyncdir_is_implemented() { fsyncdir_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, datasync: c_int, fi: *Struct_fuse_file_info) },
        statfs: if ops.statfs_is_implemented() { statfs_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t) },
        setxattr: if ops.setxattr_is_implemented() { setxattr_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, name: *c_schar, value: *u8, size: size_t, flags: c_int) },
        getxattr: if ops.getxattr_is_implemented() { getxattr_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, name: *c_schar, size: size_t) },
        listxattr: if ops.listxattr_is_implemented() { listxattr_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, size: size_t) },
        removexattr: if ops.removexattr_is_implemented() { removexattr_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, name: *c_schar) },
        access: if ops.access_is_implemented() { access_impl } else { 0 as extern "C" fn(req: fuse_req_t, ino: fuse_ino_t, mask: c_int) },
        create: if ops.create_is_implemented() { create_impl } else { 0 as extern "C" fn(req: fuse_req_t, parent: fuse_ino_t, name: *c_schar, mode: mode_t, fi: *Struct_fuse_file_info) },
